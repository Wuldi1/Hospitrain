...
```json
{
  ...
  "description": "...",
  "components": [
    { "id": "comp-1", "name": "בטיחות", "categories": [
      { "id": "cat-1", "name": "ציוד", "requirements": [
...
```json
{
  ...
  "events":[
    {"id":"ev-1","timeOffset":"00:00","title":"תחילת תרגיל","message":"..." },
    {"id":"ev-2","timeOffset":"00:03","title":"דיווח מחלקה","message":"..." }
  ]
}
```
